...
export const initialResumeStateId = {
  title: "Resume Baru",
  basic: {
    name: "Budi Santoso",
    title: "Insinyur Frontend Senior",
    employementStatus: "Tersedia",
  ...
  education: [
    {
      ...
      gpa: "",
      description: `<ul>
        <li>Mata kuliah inti: Struktur Data, Algoritma, Sistem Operasi, Jaringan Komputer, Pengembangan Web</li>
        <li>Top 5% di kelas, menerima penghargaan Dean's List selama tiga tahun berturut-turut</li>
        <li>Menjabat sebagai Direktur Teknis Asosiasi Ilmu Komputer, menyelenggarakan berbagai lokakarya teknis</li>
        <li>Berkontribusi pada proyek sumber terbuka, mendapatkan sertifikasi GitHub Campus Expert</li>
      </ul>`,
    },
  ],
  skillContent: `<div class="skill-content">
  <ul>
    <li>Framework Frontend: React, Vue.js, Next.js, Nuxt.js dan framework SSR lainnya</li>
    <li>Bahasa: TypeScript, JavaScript(ES6+), HTML5, CSS3</li>
    <li>UI/Styling: TailwindCSS, Sass/Less, Modul CSS, Styled-components</li>
    <li>Manajemen State: Redux, Vuex, Zustand, Jotai, React Query</li>
    <li>Alat Build: Webpack, Vite, Rollup, Babel, ESLint</li>
    <li>Pengujian: Jest, React Testing Library, Cypress</li>
    <li>Performa: Prinsip rendering browser, pemantauan metrik performa, pemisahan kode, lazy loading</li>
    <li>Kontrol Versi: Git, SVN</li>
    <li>Kepemimpinan Teknis: Pengalaman manajemen tim, memimpin pemilihan teknologi dan desain arsitektur untuk proyek besar</li>
  </ul>
</div>`,
  selfEvaluationContent: "",
  experience: [
    {
      id: "1",
      company: "ByteDance",
      position: "Insinyur Frontend Senior",
      date: "2021.07 - 2024.12",
      visible: true,
      details: `<ul>
      <li>Bertanggung jawab atas pengembangan dan pemeliharaan Platform Kreator TikTok, memimpin desain solusi teknis untuk fitur inti</li>
      <li>Mengoptimalkan konfigurasi build, mengurangi waktu build dari 8 menit menjadi 2 menit, meningkatkan efisiensi pengembangan tim</li>
      <li>Merancang dan mengimplementasikan perpustakaan komponen, meningkatkan penggunaan kembali kode sebesar 70%, secara signifikan mengurangi waktu pengembangan</li>
      <li>Memimpin proyek pengoptimalan performa, mengurangi waktu pemuatan layar pertama platform sebesar 50%, mengintegrasikan sistem pemantauan APM</li>
      <li>Membimbing insinyur junior, menyelenggarakan sesi berbagi teknis untuk meningkatkan kemampuan teknis tim secara keseluruhan</li>
    </ul>`,
    },
  ],
  draggingProjectId: null,
  projects: [
    {
      id: "p1",
      name: "Platform Kreator TikTok",
      role: "Lead Frontend",
      date: "2022.06 - 2023.12",
      description: `<ul>
        <li>Platform analitik dan manajemen konten berbasis React yang melayani jutaan kreator</li>
        <li>Mencakup subsistem analitik data, manajemen konten, dan manajemen pendapatan</li>
        <li>Mengimplementasikan Redux untuk manajemen state, memungkinkan penanganan alur data kompleks yang efisien</li>
        <li>Menggunakan perpustakaan komponen Ant Design untuk memastikan konsistensi UI dan pengalaman pengguna</li>
        <li>Mengimplementasikan strategi pemisahan kode dan lazy loading untuk mengoptimalkan performa pemuatan</li>
      </ul>`,
      visible: true,
    },
    {
      id: "p2",
      name: "Alat Pengembang WeChat Mini Program",
      role: "Pengembang Inti",
      date: "2020.03 - 2021.06",
      description: `<ul>
        <li>Solusi lengkap untuk pengembangan, debugging, dan penerbitan mini program</li>
        <li>Aplikasi desktop lintas platform yang dibangun dengan Electron</li>
        <li>Mendukung berbagai platform termasuk Windows, macOS, dan Linux</li>
        <li>Menyediakan pencatatan kesalahan real-time dan alat analisis performa</li>
        <li>Mengintegrasikan plugin pihak ketiga dan SDK untuk fungsionalitas kustom</li>
      </ul>`,
      visible: true,
    },
    {
      id: "p3",
      name: "Platform Pemantauan Frontend",
      role: "Lead Teknis",
      date: "2021.09 - 2022.05",
      description: `<ul>
        <li>Solusi pemantauan frontend lengkap termasuk pelacakan kesalahan, pemantauan performa, dan analisis perilaku pengguna</li>
        <li>Dibangun dengan Vue dan Element UI, menyediakan data pemantauan real-time dan alat visualisasi</li>
        <li>Mendukung berbagai metrik pemantauan termasuk log kesalahan, indikator performa, dan analisis perilaku pengguna</li>
        <li>Menyediakan log kesalahan terperinci dan alat analisis performa untuk membantu pengembang mengidentifikasi dan mengoptimalkan masalah</li>
        <li>Mengintegrasikan plugin pihak ketiga dan SDK untuk fungsionalitas kustom</li>
      </ul>`,
      visible: true,
    },
...
export const blankResumeStateId = {
  ...initialResumeStateId,
  title: "Resume Baru",
  basic: {
    ...initialResumeStateId.basic,
    name: "",
    title: "",
    email: "",
    phone: "",
  ...
  projects: [],
  certificates: [],
  menuSections: [initialResumeStateId.menuSections[0]],
};
